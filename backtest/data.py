...
def load_csv_paths(paths: list[Path], symbol_col_from_name: bool = True) -> Dict[str, pd.DataFrame]:
    """Load OHLCV CSVs from explicit paths.

    This mirrors :func:`load_csv_folder` but accepts a list of paths so callers
    can work with pre-resolved datasets without going through globbing.
    """
